    ...
    <div>
      <div className="relative z-10 h-dvh w-screen overflow-hidden bg-blue-75">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white px-4">
          <h1
            className={`text-5xl md:text-7xl mb-2 drop-shadow-lg font-anton ${
              videoLoading ? "opacity-0" : "opacity-100"
            }`}
          >
          ...
          <p
            className={`text-md md:text-3xl mb-4 font-spartan ${
              videoLoading ? "opacity-0" : "opacity-100"
            }`}
          >
          ...
          <div className={`${videoLoading ? "opacity-0" : "opacity-100"}`}>
            <Button
              id="browse-menu"
              title="Browse Menu"
